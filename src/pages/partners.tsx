  ...
  return (
    <>
      ...
      <div className="my-12 mx-4">
        ...
        <h1 className={"heading my-12"}>Introducing with great excitement: ICIMMI 2026, in partnership with IIIT Nagpur, Asia University Taiwan, and Namibia University.</h1>
        <p className="my-12">
