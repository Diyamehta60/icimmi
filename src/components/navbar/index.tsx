  ...
  return (
    ...
    >
      ...
      {dropOpen && (
        <div
          id="dropNav"
          className={`-left-1/2 z-10 mt-3 w-fit w-full divide-y divide-amber-800 rounded bg-amber-100 font-normal shadow-lg md:absolute ${title.toLowerCase().includes("archive") ? "md:w-36" : "md:w-52"
            }`}
        >
        ...
        <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between gap-y-6 p-4">
          <div className={"flex w-full flex-row items-center "}>
            ...
            <div className={"flex flex-row items-center justify-normal gap-1"}>
              <span
                onClick={menuToggle}
                className="focus:ring-none order-last inline-flex cursor-pointer items-center rounded-lg p-2 text-sm  text-[#034EA2] focus:outline-none hover:bg-red-700 md:hidden"
              >
          ...
          {
            <div
              className={`${menuOpen ? "w-full md:block lg:w-auto" : "hidden md:block"
                }`}
            >
